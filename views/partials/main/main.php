<main>
    ...
    <section>
        <h1>Rent a car and drive happy with our country coverage</h1>
        <div>
            <div>
                <h2>
                    Start a reservation
            ...
            <div>
                * You can do rent a car without register
            </div>
        </div>
    </section>
    <main>
    <section>
        <div>
            <select>
                <option value="1" selected>Return in same place</option>
                <option value="2">Return in a different place</option>
            </select>
            <div>Cancel</div>
        </div>
        <div>
        ...
        <div>
            ...
            <div>
                ...
                <select name="dropoff-time" id="dropoff-time">
                    <option value="00:00">00:00</option>
                    <option value="00:30">00:30</option>
                    <option value="01:00">01:00</option>
                    <option value="01:30">01:30</option>
